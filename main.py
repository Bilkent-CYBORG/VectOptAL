...
def test_partial_model():
    ...
    def print_model_params():
        for model_i, m in enumerate(model.model.models):
            print(
                f"Model: {model_i}, Parameter: Noise, "
                f"value = {m.likelihood.noise.tolist()}"
            )
            print(
                f"Model: {model_i}, Parameter: Mean, "
                f"value = {m.mean_module.constant.tolist()}"
            )
            print(
