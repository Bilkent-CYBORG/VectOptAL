...
from vectoptal.maximization_problem import BraninCurrin
...
class TestVOGP_AD(unittest.TestCase):
    def setUp(self):
        ...
        to initialize parameters for the VOGP
        instance and prepare for testing both
        individual phases and full runs.
        """
    ...
    def test_discarding(self):
        """Test the discarding phase of VOGP_AD."""
    ...
    def test_epsilon_covering(self):
        """Test the epsilon covering phase of VOGP_AD."""
        self.algorithm.beta = self.algorithm.compute_beta()
    ...
    def test_vogp_ad_run(self):
        """
        This test performs a full run
        of the VOGP_AD algorithm on the
        BraninCurrin dataset and
        calculates the hypervolume score
