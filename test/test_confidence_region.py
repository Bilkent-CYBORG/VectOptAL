...
class TestRectangularConfidenceRegion(TestCase):
    ...
    def test_update(self):
        ...
        self.confidence_region.update(np.array([1, 1]), 0.25 * np.eye(2))
        self.assertTrue((self.confidence_region.lower == np.array([0.5, 0.5])).all())
        self.assertTrue((self.confidence_region.upper == np.array([1, 1])).all())
