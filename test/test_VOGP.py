...
class TestVOGP(unittest.TestCase):
    ...
    def test_discarding(self):
        """Test the discarding phase of VOGP."""
        ...
        for _ in range(self.iter_count):
            ...
            self.algorithm.S = set(
                range(self.algorithm.design_space.cardinality)
            )
            ...
            self.assertEqual(
                self.algorithm.S, {1}, "Wrong design was discarded."
            )

        print("test_discarding passed.")

    def test_epsilon_covering(self):
        """Test the epsilon covering phase of VOGP."""
        ...
        for _ in range(self.iter_count):
            ...
            self.assertEqual(
                self.algorithm.P, {1}, "Wrong design was added to Pareto."
            )
        print("test_epsilon_covering passed.")

    def test_evaluating(self):
        """Test the evaluating function of VOGP."""
    ...
    def test_vogp_run(self):
        ...
        print(
            f"Avg. eps-F1 score: {avg_eps_f1:.2f}"
        )
        self.assertGreaterEqual(
